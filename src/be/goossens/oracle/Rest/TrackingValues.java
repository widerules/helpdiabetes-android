...
public class TrackingValues {
	...
	public static final String pageShowFoodListOnClickCreateFood = pageShowFoodList + "ClickCreateFood";
	public static final String pageShowFoodListOnClickAddFoodToSelection = pageShowFoodList + "ClickAddFoodToSelection";
