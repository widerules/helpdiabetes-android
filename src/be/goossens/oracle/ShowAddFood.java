...
public class ShowAddFood extends Activity {
	...
	private void setSelectedFoodUnitItemInSpinnerSelected(int selectedFoodUnitId) {
		...
		CustomAdapterUnit adapter = (CustomAdapterUnit) spinnerFoodUnits
				.getAdapter();
	...
	private void fillData() {
		...
		CustomAdapterUnit adapter = new CustomAdapterUnit(this,
		...
		adapter.setDropDownViewResource(R.layout.add_food_spinner_popup_row);
	}
