...
import be.goossens.oracle.slider.SliderContainer.OnTimeChangeListener;
...
//	private static String TAG = "DATESLIDER";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.slider_dialogtitle);
