...
public class ScrollLayout extends LinearLayout {
    ...
    public ScrollLayout(Context context, AttributeSet attrs) {
        ...
        rightShadow = getContext().getResources().getDrawable(R.drawable.slider_right_shadow);
        leftShadow = getContext().getResources().getDrawable(R.drawable.slider_left_shadow);
